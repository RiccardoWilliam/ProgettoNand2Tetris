...
class Parser:
    ...
    def __instruction_args_check(self, instruction: list[str]):
        ...
        #if its a push/pop (TODO add other segments later), check length, segment and index, then assign args
        if self.__instruction_type in (CommandType.C_PUSH, CommandType.C_POP):
            ...
            #     SegmentType.S_ARGUMENT.value,
            #     SegmentType.S_LOCAL.value,
            #     SegmentType.S_THIS.value,
            #     SegmentType.S_THAT.value,
            #     SegmentType.S_TEMP.value,
            #     SegmentType.S_POINTER.value,
            #     SegmentType.S_CONSTANT.value,
            #     SegmentType.S_STATIC.value
            # ):
            #     print(f"Invalid instruction segment at line {self.__current_line}")
            #     print(f"instruction: {self.__current_instruction}")
            #     exit()
